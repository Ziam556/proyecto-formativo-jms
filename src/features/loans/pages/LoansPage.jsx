...
export default function LoansPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center p-6">
      ...
      {/* CONTENEDOR */}
      <div className="rounded-[20px] overflow-hidden bg-gradient-to-r from-[#700D7C] via-[#88A3C7] to-[#50E5F9] backdrop-blur-xl shadow-[0_8px_40px_rgba(0,0,0,0.3)] max-w-[680px] w-full px-10 py-12">
