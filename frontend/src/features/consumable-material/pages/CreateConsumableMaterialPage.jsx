...
export default function CreateConsumableMaterialPage() {
    ...
    const stepComponents = [
        <CreateConsumable1 key={0} formData={formData} onNext={handleNext} onCancel={() => navigate("/dashboard/consumable-material")} />,
        <CreateConsumable2 key={1} formData={formData} onNext={handleNext} onBack={handleBack} />,
        <CreateConsumable3 key={2} formData={formData} onSave={handleSave}  onBack={handleBack} />,
    ];
