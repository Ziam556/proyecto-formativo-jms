...
export default function EditConsumableMaterial2({
    ...
    const handleNext = () => {
        ...
        if (!fields.materialStoryTeller)
            newErrors.materialStoryTeller = "El cuentadante es requerido";
        if (!fields.materialAmount)
            newErrors.materialAmount = "La cantidad es requerida";
        if (!fields.materialUnitValue)
            newErrors.materialUnitValue = "El valor unitario es requerido";
        if (!fields.materialTotalValue)
            newErrors.materialTotalValue = "El valor total es requerido";
