...
export default function UserEditForm({ initialUser, userImage, isEnabled, onCancel }) {
    ...
    // Cuando cambia el usuario seleccionado desde la búsqueda, repoblar el form
    useEffect(() => {
    ...
    const handleSubmit = async () => {
        ...
        // ── 2. Validación Zod (excluye password si está vacío en edición) ─────
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div className="relative">
                        ...
                        <button
                            ...
                            className={`absolute right-[10px] ${errors.userPhone ? "bottom-[26px]" : "bottom-[13px]"} w-[22px] h-[22px] rounded border-0 cursor-pointer flex items-center justify-center z-[2] ${
                                formData.userSecondaryPhone ? "bg-[#50E5F9]" : "bg-[rgba(80,80,180,0.25)]"
                            }`}
                        >
